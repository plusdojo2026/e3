...
<body>
	...
	<main>
		...
		<div class = "explane">
			...
			カードをクリックすると、商品詳細が確認できます。また、表示順は▼を押して任意の項目順［登録・経過日数・固定費］に並び替えることができます。 <br><br><br>
			
			<strong>✅商品詳細</strong><br> 
			モノの詳細情報を見ることができます。<br>
			登録した全ての情報に加え、１日当たりの価格と使った期間、目標達成までの期間をペットが教えてくれます。<br>
			...
			一覧では、カード状に［愛称・アイコン・商品名・使用日数・各商品の固定費］が表示され、
			カードをクリックすると、詳細が確認できます。表示順は▼で任意の項目順［登録・経過日数・固定費］に並び替えることができます。
			...
			アルバム一覧ページから確認でき、
			表示順は▼で任意の項目順［登録・経過日数・固定費］に並び替えることができます。
