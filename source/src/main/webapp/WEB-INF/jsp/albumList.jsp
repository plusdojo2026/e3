...
<body>
	...
	<main>
		...
		<h2 class="listtitle">
			<b>▶ アルバム </b>：<br class="mediabr"> 使い終わった<strong>モノ</strong>たちを見てみよう！
		</h2>
		...
		<div class="sort">
			...
			<div class="dropdown">
				<a
					href="${pageContext.request.contextPath}/AlbumListServlet?sort=id_desc">購入日が新しい順</a>
				<a
					href="${pageContext.request.contextPath}/AlbumListServlet?sort=id_asc">購入日が古い順</a>
				<a
					href="${pageContext.request.contextPath}/AlbumListServlet?sort=progress_desc">使用日数が長い順</a>
				<a
					href="${pageContext.request.contextPath}/AlbumListServlet?sort=progress_asc">使用日数が短い順</a>
				<a
					href="${pageContext.request.contextPath}/AlbumListServlet?sort=day_price_desc">１日あたりの価格が多い順</a>
				<a
					href="${pageContext.request.contextPath}/AlbumListServlet?sort=day_price_asc">１日あたりの価格が少ない順</a>
			</div>
		</div>
